...
the errors coming from unmodeled (friction) forces and learn the multi body dynamics parameters.
'''
...
with Tee(cfg_model.s_gp_dyn.addFolderAndPrefix('TrainingResults-log')):
    ...
    if cfg_model.s_gp_dyn.train:
        ...
        # split parameter list in  1) gp hyper-parameters and  2) mbd parameters
        ...
        for i in range(iter_init, targetIter):
            ...
            if cfg_model.s_gp_dyn.train_sgp: opt_gp.step()
