...
surface_fun   = lambda r: array([r[1]+1])   # c(r) = y + 1 = 0
surface_fun_J = lambda r: array([[0,1.,0]])
surface_fun_H = lambda r: zeros((3,3))
surfaceConstraint = BodyOnSurfaceBilateralConstraint(
    link2, 
    P_r_PDp=array([0.5,0,0]), 
...
pendulum = MultiRigidBody(ground=ground, bilateralConstraints=[surfaceConstraint])
nq = pendulum.nq

# set initial conditions
pendulum.setJointStates( q = array([0,-90]) * pi/180 )
